...
public interface StockRepository extends JpaRepository<Stock, Long> {
	...
	@Query(value="select * from stock as s, product as p,user as u where s.product_id=p.product_id and  s.supplier_id=u.user_id and s.supplier_id=?1 ",nativeQuery = true)
